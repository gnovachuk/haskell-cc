...
opToInstr LessOp = "  cmp x0, x1\n" ++ "  cset x0, lt"
opToInstr LessEqualOp = "  cmp x0, x1\n" ++ "  cset x0, le"
opToInstr GreaterOp = "  cmp x0, x1\n" ++ "  cset x0, gt"
opToInstr GreaterEqualOp = "  cmp x0, x1\n" ++ "  cset x0, ge"
opToInstr EqualOp = "  cmp x0, x1\n" ++ "  cset x0, eq"
opToInstr NotEqualOp = "  cmp x0, x1\n" ++ "  cset x0, ne"
